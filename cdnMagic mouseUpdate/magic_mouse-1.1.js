...
function magicMouse(e) {
    if (!Modernizr.touchevents) {
        ...
        var m = () => {
            o && (o.style.transform = "matrix(1, 0, 0, 1, " + c + ", " + d + ")", o.style.width = n + "px", o.style.height = i + "px"), r && (r.style.transform = "matrix(1, 0, 0, 1, " + u + ", " + f + ") translate3d(-50%, -50%, 0)"), requestAnimationFrame(m)
        };
        ...
        const v = e => {
                if (h = !0, o) {
                    ...
                    e.classList.contains("magic-hover__square") ? (o.classList.add("cursor-square"), c = t.left, d = t.top, n = t.width, i = t.height) : (c = t.left, d = t.top, n = t.width, i = t.height)
                }
                r && r.classList.add("is-hover")
            },
            p = () => {
                h = !1, o && (n = a, i = l, o.style.transition = "transform 0.07s, width 0.3s, height 0.3s, border-radius 0.2s", o.classList.remove("cursor-square"), o.classList.remove("is-hover")), r && r.classList.remove("is-hover")
            },
            g = (e, t) => {
                r && r.classList.add(t)
            },
...
! function (e, t, o) {
    ...
    var u = t.documentElement,
        ...
        h = l.testStyles = function (e, o, s, i) {
            ...
            return (a = r("style")).type = "text/css", a.id = "s" + f, (m.fake ? m : h).appendChild(a), m.appendChild(h), a.styleSheet ? a.styleSheet.cssText = e : a.appendChild(t.createTextNode(e)), h.id = f, m.fake && (m.style.background = "", m.style.overflow = "hidden", d = u.style.overflow, u.style.overflow = "hidden", u.appendChild(m)), l = o(h, e), m.fake ? (m.parentNode.removeChild(m), u.style.overflow = d, u.offsetHeight) : h.parentNode.removeChild(h), !!l
        };
        ...
        function () {
            ...
            for (var d in a)
                if (a.hasOwnProperty(d)) {
                    ...
                    for (r = s(t.fn, "function") ? t.fn() : t.fn, n = 0; n < e.length; n++) 1 === (l = e[n].split(".")).length ? c[l[0]] = r : (!c[l[0]] || c[l[0]] instanceof Boolean || (c[l[0]] = new Boolean(c[l[0]])), c[l[0]][l[1]] = r), i.push((r ? "" : "no-") + l.join("-"))
                }
        }(),
        function (e) {
            var t = u.className,
...
var num = document.querySelectorAll('.magic-hover')
...
for (const name of num) {
    ...
    name.addEventListener('mouseleave', function() {
        // document.querySelector('#magicMouseCursor').style.display = 'block'
    })
}
...
document.addEventListener('mouseleave', function() {
    // document.querySelector('#magicMouseCursor').style.display = 'none'
    // document.querySelector('#magicPointer').style.display = 'none'
})
// document.querySelector('html')
document.addEventListener('mouseenter', function() {
    // document.querySelector('#magicMouseCursor').style.display = 'block'
    // document.querySelector('#magicPointer').style.display = 'block'
})
